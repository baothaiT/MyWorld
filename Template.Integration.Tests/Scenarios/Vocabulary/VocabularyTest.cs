...
using Template.Integration.Tests.Collections;
...
public class VocabularyTest : VocabularyFixture
{
    ...
    public async Task GetVocabulary_ReturnsOkStatusCode(string url)
    {
        ...
        await _webapplication.App.ResourceNotifications.WaitForResourceHealthyAsync(nameof(ServiceNameEnum.TemplateAPI), cts.Token);
