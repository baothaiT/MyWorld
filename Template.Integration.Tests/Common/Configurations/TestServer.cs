...
using Template.ServiceDefaults.Common.Extensions;

namespace Template.Integration.Tests.Common.Configurations
{
    public class TestServer : IAsyncLifetime
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            _appTestingBuilder = await DistributedApplicationTestingBuilder.CreateAsync<Projects.Template_AppHost>();
            // _appTestingBuilder = await DistributedApplicationTestingBuilder.CreateAsync<Projects.Template_AppHost>
            // (
            // args: [],
            ...
            Client = App.CreateHttpClient(nameof(ServiceNameEnum.TemplateAPI));
        }
